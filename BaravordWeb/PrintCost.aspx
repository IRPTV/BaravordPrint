<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintCost.aspx.cs" Inherits="BaravordWeb.PrintCost" %>
                        ...
                        <div>
                            <table style="width: 100%; border: solid 2px black; border-radius: 5px;">
                                ...
                                <tr>
                                    <td colspan="6">
                                        <table style="width: 100%; border: solid 1px black; border-radius: 5px; background-color: #cccccc;">
                                            <tr>
                                                ...
                                                <td style="text-align: right">
                                                    <asp:Label ID="Label23" dir="rtl" Font-Size="12pt" runat="server" CssClass="LblParametersTitle" Text="..." Font-Italic="True"></asp:Label>
                                                </td>
                                                <td style="width: 70px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label16" runat="server" CssClass="LblParametersTitle" Text=":نویسنده"></asp:Label>
                                                </td>
                                                <td>
                                        ...
                                        <asp:Label ID="Label8" runat="server" CssClass="LblParametersTitle" Text=":کارگردان"></asp:Label>
                                                ...
                                                <td style="text-align: right">
                                                    <asp:Label ID="Label19" Font-Size="12pt" dir="rtl" runat="server" CssClass="LblParametersTitle" Text="..." Font-Italic="True"></asp:Label>
                                                </td>
                                                <td style="width: 70px;">
                                                    <asp:Label ID="Label20" runat="server" CssClass="LblParametersTitle" Text=":عنوان مخاطب"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 40px; text-align: right;">
                                        <asp:Label ID="Label48011" runat="server" CssClass="LblParametersTitle" Text=":نوع تسویه"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px; text-align: right;">
                                        <asp:Label ID="Label48004" runat="server" CssClass="LblParametersTitle" Text=": تاریخ تصویب "></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                ...
                <tr>
                    <td>
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td class="TitleHeaderTd">توضیحات تکمیلی</td>
                            </tr>
                            <tr>
                                <td>
