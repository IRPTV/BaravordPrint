...
{
    public partial class PrintCost : System.Web.UI.Page
    {
...
//                    Label48008.Text = "";
                ...
                //Label48017.Text = Br_Dt[0]["tarhNumber"].ToString();
                //Label48019.Text = DateConversion.GD2JD(DateTime.Parse(Br_Dt[0]["Datetime_Tarh"].ToString()));

                //if(bool.Parse(Br_Dt[0]["ArchiveBuy"].ToString()))
                //{
                //    Label48023.Text = "دارد";

                //}
                //else
                //{
                //    Label48023.Text = "ندارد";
                //}

                //switch (Br_Dt[0]["VisaByProvider"].ToString())
                //{
                //    case "2": Label48025.Text = "به عهده شبکه";
                //        break;
                //    case "1": Label48025.Text = "به عهده تهیه کننده";
                //        break;
                //    case "3": Label48025.Text = "-----";
                //        break;
                //    default:
                //        break;
                //}
                ...
                //{
                //    Label48024.Text = "خرید رایت";
                //}

                //if (Br_Dt[0]["Music"].ToString() == "2")
                //{
                //    Label48024.Text = "تولیدی";
                //}

                //Label48027.Text = Br_Dt[0]["Latest_Delivery"].ToString() + " روز ";
                ...
                MyDB.BaravordDataTable Role_Dt2 = Br_Ta.Select_Programe_Role(Program_Id);
                GridView3.DataSource = Role_Dt2;
                GridView3.DataBind();
                ...
                Label15.Text = Br_Dt[0]["Writer_Name"].ToString();
                Label19.Text = Br_Dt[0]["Title_2"].ToString();
